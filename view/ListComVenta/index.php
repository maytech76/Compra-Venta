...
$rol = new Rol();
$datos = $rol->validar_acceso_rol($_SESSION["USU_ID"], "Comisiones");
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Comisiones - <span class="text-success">Ventas Efectivas</span></h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <table id="tabla_comisiones" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>CODIGO</th>
