<?php
  ...
  class TipoVehiculo extends Conectar{
        ...
        public function get_tipo_x_suc_id($suc_id){
        ...
        public function get_tipo_x_tipo_id($tipo_id){
            $conectar=parent::Conexion();
        ...
        /* TODO:Insertar Nuevo Registro de Tipos */
        public function insert_tipo($suc_id, $tipo_nom){
        ...
        /* TODO:Actualizar Registro de tipo por TIPO_ID */
        public function update_tipo($tipo_id, $suc_id, $tipo_nom){
