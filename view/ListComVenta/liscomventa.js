...
$(document).ready(function(){
    ...
    $('#tabla_comisiones').DataTable({
        ...
        "ajax":{
            url:"../../controller/comisionventa.php?op=listar",
            type:"post",
            data:{suc_id:suc_id}
        },
        "bDestroy": true,
...
/* TODO:Modal Muestra el listado total de comision por vend_id */
function ver(vend_id){
...
$(document).on("click","#pagar_comision",function(){
  var vend_id =$("#vend_id").val();

        $.post("../../controller/comisionventa.php?op=pagar_comision",{
            vend_id:vend_id
        },function(data){
