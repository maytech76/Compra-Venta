<?php
    ...
    switch($_GET["op"]){
        ...
        case "guardardetalle":
            $datos=$compra->insert_compra_detalle(
                $_POST["compr_id"],
                $_POST["prod_id"],
                $_POST["prod_pcompra"],
                $_POST["detc_cant"]);
        ...
        /* TODO:Eliminar Detalle de listado de compras*/
        ...
        /* TODO: VISUALIZAMO EL LISTADO DE PRODUCTOS INVOLUCRADOS EN LA COMPRA  ViewCompra */
        ...
        /* TODO: Actualizar  cabecera de compra a est=1 */
        case "guardar":
        ...
        /* TODO: Mostrar datos de la Cabecera en compra por COMP_ID */
        case "mostrar":
        ...
        /* TODO: Listar todas las compras por sucursal  en Modulo ListCompra*/
         case "listarcompra":
                ...
                foreach($datos as $row){
                    ?>
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <?php
                                        if ($row["PROD_IMG"] != ''){
                                            ...
                                            ?>
                                                <?php 
                                                    echo "<img src='../../assets/images/productos/no_image.png' alt='' class='img-fluid d-block' />";
                                                ?>
                                            <?php
                                        }
                                    ?>
                                    ...
                                    <div>
                                        <h6 class="fs-12 my-1"><?php echo $row["PROD_NOM"];?></h6>
                                        <span class=" fs-11 text-muted"><?php echo $row["CAT_NOM"];?></span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <h6 class="fs-12 my-1 fw-normal"><?php echo $row["PROD_PCOMPRA"];?></h6>
                            ...
                            <td>
                                <h6 class="fs-12 my-1 fw-normal"><?php echo $row["PROD_STOCK"];?></h6>
                                <span class="text-muted">Stock</span>
                            </td>
                            <td>
                                <h6 class="fs-12 my-1 fw-blod text-danger"> $ <?php echo $row["TOTAL"];?></h6>
