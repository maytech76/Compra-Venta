                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="mt-sm-5 mt-4">
                                                        ...
                                                        <h6 class="fw-medium mb-1"><span id="txtdirecc"></span></h6>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row g-3">
                                                <div class="col-lg-3 col-6">
                                                    <p class="text-muted mb-2 text-uppercase fw-semibold">N° de Venta</p>
                                                    <h5 class="fs-14 mb-0">VENT-<span id="vent_id"></span></h5>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-6">
                                                    <p class="text-muted mb-2 text-uppercase fw-semibold">forma de Pago</p>
                                                    <span class="badge badge-soft-success fs-11" id="pag_nom"></span>
                                                </div>

                                                <div class="col-lg-3 col-6">
                                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Total General</p>
