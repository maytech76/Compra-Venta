...
$(document).ready(function(){
   ...
   /* TODO: REALIZAMOS CONSULTA AL CONTOLADOR COMPRA.PHP METODO MOSTRAR SEGUN COMPR_ID */
    $.post("../../controller/compra.php?op=mostrar",{compr_id:compr_id},function(data){
     ...
     /* TODO:CONSULTAMOS EL CONTROLADOR COMPRA.PHP EL METODO LISTARDETALLEFORMATO SEGUN PARAMETRO COMPR_ID */
    $.post("../../controller/compra.php?op=listardetalleformato",{compr_id:compr_id},function(data){

        /* TODO:EL RESULTADO DE DATA LOS PASAMOS AL ELEMENTO #listardetalle de la datatable viewCompra */
