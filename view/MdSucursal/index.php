...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Modulo de <span class="text-secondary">Sucursal</span></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="tablasucursal" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                <thead>
                                                    <tr>
    ...
    <script type="text/javascript" src="mdsucursal.js"></script>
</body>
