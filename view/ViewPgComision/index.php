                                                ...
                                                <div class="card-header border-bottom-dashed p-4">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column bd-highlight mb-3 col-lg-3 col-6">
                                                            ...
                                                            <h5 class="text-info">Por Ventas</h5>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-3 col-6">
                                                            <div class="mt-sm-5 mt-4">
                                                                ...
                                                                <h6 class="text-muted fw-medium mb-1 pl-2" value="0" name="txtvend_id" >00<span id="txtvend_id"></span></h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 col-6">
                                                            <div class="mt-sm-5 mt-4">
                                                ...
                                                <div class="card-body pt-2 px-4">
                                                    <div class="row g-3">
                                                        <div class="col-lg-3 col-6">
                                                            ...
                                                            <h5 class="fs-14 mb-0 text-success">00<span id="txtcantvent"></span></h5>
