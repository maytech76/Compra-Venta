<?php /* TODO:Conectamos con DB E Iniciamos $_SESSION */
...
if(isset($_SESSION["USU_ID"])){
    if(is_array($datos) and count($datos)>0){ 
        ...
        /* consultamos tablas de db por informacion  */
        require_once("../../models/Producto.php");
        $producto = new Producto();
        $number_products = $producto->get_producto_x_suc_id($_SESSION["SUC_ID"]);

        require_once("../../models/Categoria.php");
        $categoria = new Categoria();
        $number_categoria = $categoria->get_categoria_x_suc_id($_SESSION["SUC_ID"]);

        require_once("../../models/Cliente.php");
        $cliente = new Cliente();
        $number_cliente = $cliente->get_cliente_x_emp_id($_SESSION["EMP_ID"]);

        require_once("../../models/Proveedor.php");
        $proveedor = new Proveedor();
        $number_proveedor = $proveedor->get_proveedor_x_emp_id($_SESSION["EMP_ID"]);
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Dashboard  <span class="text-secondary">Mananger</span></h4>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                <!-- TODO:HEADER WELCOME AND BUTTONS -->
                                <div class="row mb-3 pb-1">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex">
                                                 <h5 class="fs-16 mb-1">Bienvenid@,</h5> <span class="mx-2 mb-1 text-success"> <?php echo $_SESSION["USU_NOM"]?>!</span>
                                            </div>
                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                <form action="javascript:void(0);">
                                                    <div class="row g-3 mb-0 align-items-end">
                                                        <div class="col-auto">
                                                            <a href="../MdProductos/" type="button" class="btn btn-soft-success"><i class="ri-add-circle-line align-middle me-1"></i> Agregar Producto</a>
                                                        </div>

                                                        <div class="col-auto">
                                                            <a href="../MdProductos/" type="button" class="btn btn-soft-warning"><i class="ri-add-circle-line align-middle me-1"></i> Agregar Producto</a>
                                                        </div>
                                ...
                                <div class="row"> <!-- TODO:INICIO DE CARS TOTALES -->

                                    <!-- TODO:Card Total Productos -->
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo count($number_products);?>"></span></h4>
                                                        <a href="../MdProductos/" class="text-decoration-underline">Modulo Productos</a>
                                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo count($number_categoria);?>"></span></h4>
                                                        <a href="../MdCategorias/" class="text-decoration-underline">Modulo Categorias</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo count($number_cliente);?>"></span> Registros</h4>
                                                        <a href="../MdClientes/" class="text-decoration-underline">Modulo Clientes</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo count($number_proveedor);?>"></span> Registros</h4>
                                                        <a href="../MdProveedores/" class="text-decoration-underline">Modulo Proveedores</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                ...
                                </div>  <!-- FINAL CARD TOTALES -->


                                <!-- TODO:GRAFICA DE BARRAS VERTICALES -->
                                <div class="row">
                                    <div class="col-xl-8">
                                        <div class="card">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex bg-info">
                                                <h4 class="text-white card-title mb-0 flex-grow-1">Top 5 Compras</h4>                                                
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive table-card">
                                                    <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                                                        <tbody id="top5compras">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex bg-success">
                                                <h4 class="text-white card-title mb-0 flex-grow-1 ">Top 5 Ventas</h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive table-card">
                                ...
                                <!-- TODO:DIAGRAMA TIPO DONALD - PRODUCTOS POR CATEGORIA -->
                                <div class="row">
                                    <div class="col-xl-4">
                                        <div class="card card-height-100">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Productos por Categoria</h4>
                                                <div class="flex-shrink-0">
                                                </div>
                                            </div>
                            ...
                            <div class="layout-rightside">
                                <div class="card h-100 rounded-0">
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <h6 class="text-muted mb-0 text-uppercase fw-semibold">Actividades Recientes</h6>
                                        </div>
                                        ...
                                        <div class="p-3">
                                            <h6 class="text-muted mb-3 text-uppercase fw-semibold">Vendedores</h6>
                                            <!-- Swiper -->
